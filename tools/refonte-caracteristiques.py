...
T = {
 'fr': dict(
  ...
  integ_lien="Les exemples d'appel, outil par outil", integ_href='documentation.html#doc-appel',
 ...
 'en': dict(
  ...
  integ_lien='The call, tool by tool', integ_href='documentation.html#doc-appel',
